...
def exibir_tela(element_pai):
    ...
    frame_selecao = tb.Frame(element_pai, padding=10)
    ...
    menu_materias = tk.OptionMenu(element_pai, var_materia_selecionada, "Cadastrar nova matéria")
    menu_materias.pack()
