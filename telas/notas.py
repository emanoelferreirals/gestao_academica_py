# notas_tela
from funcs import carregar_dados, salvar_dados, on_close,abrir_nova_tela, acessar_bd, ler_login, carregar_lista_materias, carregar_periodos  
...
def exibir_tela(element):
    ...
    canvas_tabela = tk.Canvas(frame_principal, width=600, height=350)
    ...
    btn_cadastrar_dados_academicos = tk.Button(frame_botoes, text="Cadastrar curso", width=20,command=lambda: abrir_cadastro_curso(element))
