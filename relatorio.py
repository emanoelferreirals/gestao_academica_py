...
os.environ["GROQ_API_KEY"] = "SUA_CHAVE_AQUI"  # Substitua pela sua chave correta
...
janela = tk.Tk()
janela.title("Gerar Relatório de Desempenho")
...
text_widget = tk.Text(janela, wrap="word", height=15, width=70)
text_widget.pack(pady=10)
text_widget.config(state=tk.DISABLED)

# Botão para exportar PDF
botao_pdf = tk.Button(janela, text="Exportar para PDF", command=exportar_para_pdf)
